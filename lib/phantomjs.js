 ...
 * @type {number}
 */
// There is no version for mac in release 2.0.0-20150528
var version = '2.0.0-20150528'
if (process.platform === 'darwin' || process.platform === 'openbsd' || process.platform === 'freebsd') {
